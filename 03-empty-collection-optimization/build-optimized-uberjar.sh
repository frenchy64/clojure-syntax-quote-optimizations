...
# Wrapper script for building empty-collection-optimized Clojure uberjar
#
...
PATCH_FILE="$SCRIPT_DIR/empty-collection-optimization.patch"
...
exec "$SHARED_SCRIPT" "empty-collection" "$PATCH_FILE" "$OUTPUT_DIR"
