...
# Wrapper script for building sets-without-splices-optimized Clojure uberjar
#
...
PATCH_FILE="$SCRIPT_DIR/sets-without-splices.patch"
...
exec "$SHARED_SCRIPT" "sets-without-splices" "$PATCH_FILE" "$OUTPUT_DIR"
