...
# Wrapper script for building singleton-sets-optimized Clojure uberjar
#
...
PATCH_FILE="$SCRIPT_DIR/singleton-sets.patch"
...
exec "$SHARED_SCRIPT" "singleton-sets" "$PATCH_FILE" "$OUTPUT_DIR"
