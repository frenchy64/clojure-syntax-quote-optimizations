...
# Wrapper script for building sets-distinct-constants-optimized Clojure uberjar
#
...
PATCH_FILE="$SCRIPT_DIR/sets-distinct-constants.patch"
...
exec "$SHARED_SCRIPT" "sets-distinct-constants" "$PATCH_FILE" "$OUTPUT_DIR"
